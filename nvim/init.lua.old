...
vim.keymap.set('n', '<leader>f', require('telescope.builtin').find_files, { desc = 'Search [F]iles in current directory' })
...
--
--  Add any additional override configuration in the to the following lsp tables. Inside the {}
local servers = {
